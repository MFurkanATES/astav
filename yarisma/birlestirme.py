...
def target_line_on_screen(image):
  ...
  cv2.line(image,(int((pixel_yatay/2))-10,int(pixel_dikey/2)),(int(pixel_yatay/2)-30,int(pixel_dikey/2)),(150,255,0),2)
  cv2.line(image,(int(pixel_yatay/2)+10,int(pixel_dikey/2)),(int(pixel_yatay/2)+30,int(pixel_dikey/2)),(150,255,0),2)
  cv2.line(image,(int(pixel_yatay/2),int(pixel_dikey/2)-10),(int(pixel_yatay/2),int(pixel_dikey/2)-30),(150,255,0),2)
  cv2.line(image,(int(pixel_yatay/2),int(pixel_dikey/2)+10),(int(pixel_yatay/2),int(pixel_dikey/2)+30),(150,255,0),2)
...
def status_on_screen(image):
  ...
  cv2.putText(image,("MOD:" + str(mode)),(5,20),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,("IZIN:" + str(armed_status)),(5,35),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
...
def batt_on_screen(image):
  ...
  cv2.putText(image,("VOLTAJ:" + str(voltage)),(5,170 -15),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,("AKIM:"   + str(current)),(5,185-15),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,("PIL:%"   + str(percentage)),(5,200-15),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
...
def sat_on_screen(image):
  ...
  cv2.putText(image,("GPS UYDU:" + str(sat_num)),(5,50),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,("LAT:"     + str(latitude)),(5,65),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,("LON:"     + str(longitude)),(5,80),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
...
def hud_on_screen(image):
  ...
  cv2.putText(image,("YER HIZI:"  + str(ground_speed)),(5,95),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,("HAVA HIZI:" + str(air_speed)),(5,110),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,("GAZ:%"      + str(throttle)),(5,125),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,("PUSULA:"    + str(heading_compass)),(5,140),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
  cv2.putText(image,(str(relative_altitude)),(5,270),cv2.FONT_HERSHEY_PLAIN,2,(0,0,255),2)
